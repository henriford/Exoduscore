...
exports.configLiveNet ={
    EXO_TRANSACTION_getURL: "c-prod-1.exodusnetwork.io",
    EXO_TRANSACTION_URL: "c-prod-1.exodusnetwork.io",
	EXO_SEED: "http://c-prod-1.exodusnetwork.io",
	ETH_NODE: "",
...
exports.configTestNet ={
    EXO_TRANSACTION_getURL: "172.17.2.118:35796",
    EXO_TRANSACTION_URL: "172.17.2.118:35796",
    EXO_SEED: "http://172.17.2.118:25003",
...
/*
There are 3 ways to customize conf in modules that use exoduscore lib:
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'exodus';
	exports.database.user = exports.database.user || 'exodus';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'Exodus-light.sqlite' : 'Exodus.sqlite');
}
