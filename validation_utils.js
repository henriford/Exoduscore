...
var web3 = require('web3/lib/utils/utils')
/**
...
function isValidAddress(address,type){
    ...
    switch (type) {
        case 'EXO':
            return (typeof address === "string" && address === address.toUpperCase() && isValidChash(address, 35));
            break;
        case 'BTC':
            return Bitcore.Address.isValid(address,'livenet');
            break;
        case 'ETH':
            return web3.isAddress(address);
            break;
        case 'SNC':
            return (typeof address === "string" && address.length == 76);
            break;
    }
